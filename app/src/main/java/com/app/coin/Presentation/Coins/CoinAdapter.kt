...
import com.app.coin.Presentation.CoinsDetails.CoinsDetailsActivity
...
class CoinAdapter(private val context: Context, var coinsList : ArrayList<Coin>)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CoinViewHolder {
        val coinView =
            LayoutInflater.from(parent.context).inflate(R.layout.coins_recycler_view, parent, false)
    ...
    override fun onBindViewHolder(holder: CoinViewHolder, position: Int) {
        ...
        holder.coinLayout.setOnClickListener {
            val intent = Intent(context, CoinsDetailsActivity::class.java)
